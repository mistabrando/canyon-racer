...
#define LOW_PRECISION`),t}function T_(e){let t="SHADOWMAP_TYPE_BASIC";return e.shadowMapType===Eh?t="SHADOWMAP_TYPE_PCF":e.shadowMapType===uf?t="SHADOWMAP_TYPE_PCF_SOFT":e.shadowMapType===Xn&&(t="SHADOWMAP_TYPE_VSM"),t}function A_(e){let t="ENVMAP_TYPE_CUBE";if(e.envMap)switch(e.envMapMode){case Vr:case Wr:t="ENVMAP_TYPE_CUBE";break;case ka:t="ENVMAP_TYPE_CUBE_UV";break}return t}function w_(e){let t="ENVMAP_MODE_REFLECTION";if(e.envMap)switch(e.envMapMode){case Wr:t="ENVMAP_MODE_REFRACTION";break}return t}function b_(e){let t="ENVMAP_BLENDING_NONE";if(e.envMap)switch(e.combine){case Wc:t="ENVMAP_BLENDING_MULTIPLY";break;case Lf:t="ENVMAP_BLENDING_MIX";break;case Cf:t="ENVMAP_BLENDING_ADD";break}return t}function R_(e){const t=e.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function L_(e,t,n,i){const r=e.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const c=T_(n),h=A_(n),u=w_(n),d=b_(n),f=R_(n),m=g_(n),g=__(s),_=r.createProgram();let p,l,v=n.glslVersion?"#version "+n.glslVersion+`
...
`)+`
`+p,l=["#define varying in",n.glslVersion===Ll?"":"layout(location = 0) out highp vec4 pc_fragColor;",n.glslVersion===Ll?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
